			...
			?><div class="sc_blogger_item_excerpt">
				<div class="sc_blogger_item_excerpt_text">
					...
					if (has_excerpt()) {
                        ...
                        echo wp_trim_words($post_exerpt, 30,'...');
				...
				if ( $show_more && !empty($post_link) && !empty($args['more_text']) ) {
					?><div class="sc_blogger_item_button sc_item_button"><a href="<?php echo esc_url($post_link); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_button sc_button sc_button_size_small', 'sc_blogger', $args)); ?>"><?php
