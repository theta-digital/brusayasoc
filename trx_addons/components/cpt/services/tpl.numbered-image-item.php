<?php
/**
 * The style "numbered-image" of the Services
 *
 * @package WordPress
    ...
    if ( has_post_thumbnail() && $args['featured']=='image') {
        trx_addons_get_template_part('templates/tpl.featured.php',
            ...
            apply_filters('trx_addons_filter_args_featured', array(
                ...
                'thumb_size' => apply_filters('trx_addons_filter_thumb_size', justitia_get_thumb_size($args['columns'] > 2 ? 'med-vertical' : 'med-vertical'), 'services-light'),
                'no_links' => empty($link),
                'link' => $link,
                'thumb_bg' => true,
