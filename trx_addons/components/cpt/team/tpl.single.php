	...
	?><article id="post-<?php the_ID(); ?>" <?php post_class( 'team_member_page itemscope' ); trx_addons_seo_snippets('', 'Article'); ?>><?php
		...
		?><div class="team_member_header"><?php
			...
			?><div class="team_member_description">
                <p class="team_member_position"><?php echo esc_html($meta['subtitle']); ?></p>
                <?php
				if ( trx_addons_sc_layouts_showed('title') ) {
					?><h4 class="team_member_title"><?php the_title(); ?></h4><?php
				}
                if (!empty($meta['brief_info'])) {
                    ?>
                    <div class="team_member_brief_info">
                        <h5 class="team_member_brief_info_title"><?php esc_attr_e('Brief info', 'justitia'); ?></h5>
				...
				<div class="team_member_details">
                    <h6 class="details_title"><?php esc_attr_e('Contacts', 'justitia'); ?></h6>
                    <?php
