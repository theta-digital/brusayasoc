...
Please install and activate it before starting to use the theme Justitia.
...
Theme documentation is available on http://justitia.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Justitia is Fontello.
