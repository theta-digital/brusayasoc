...
if ( ! function_exists( 'justitia_trx_addons_add_theme_vars' ) ) {
	add_filter( 'justitia_filter_add_theme_vars', 'justitia_trx_addons_add_theme_vars', 10, 2 );
	function justitia_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'justitia_trx_addons_get_css' ) ) {
	add_filter( 'justitia_filter_get_css', 'justitia_trx_addons_get_css', 10, 2 );
	function justitia_trx_addons_get_css( $css, $args ) {
...
.sc_blogger .sc_blogger_item .sc_blogger_item_content .post_meta_item,
...
.trx_addons_tooltip:after {
	border-top-color: {$colors['inverse_bd_color']};
}
...
.sc_slider_controls:not([class*="slider_pagination_style_none"]).slider_pagination_style_bullets .slider_pagination_bullet.swiper-pagination-bullet-active,
.sc_slider_controls:not([class*="slider_pagination_style_none"]).slider_pagination_style_bullets .slider_pagination_bullet:hover {
	background-color: {$colors['extra_bg_color']};
}
...
.footer_wrap .scheme_self .sc_title.sc_title_default h6.sc_item_subtitle {
...
.sc_action_item_event .sc_action_item_inner {
	background-color:{$colors['bg_color']};
}
...
.sc_blogger.scheme_self .sc_blogger_item {
...
.sc_blogger_plain .sc_blogger_item .sc_blogger_item_content .post_meta_item {
	color: {$colors['text_link']};
	background-color: {$colors['extra_bg_hover']};
}
...
.footer_wrap .scheme_self .sc_icons .sc_icons_item_title {
	color: {$colors['text']};
}
.sc_icons.sc_icons_simple .sc_icons_item {
	border-color: {$colors['bd_color']};
}
.scheme_self.footer_wrap .sc_icons.sc_icons_simple .sc_icons_item_title {
	color: {$colors['text_light']};
}
.scheme_self.footer_wrap .sc_icons .sc_icons_item_description {
	color: {$colors['text_dark']};
}
.footer_wrap .scheme_self .sc_icons .sc_icons_item_description {
	color: {$colors['text_dark']};
}
.footer_wrap .scheme_self .sc_icons .sc_icons_item_linked .sc_icons_item_description {
	color: {$colors['text_dark']};
}
.footer_wrap .scheme_self .sc_icons .sc_icons_item_linked:hover .sc_icons_item_description {
	color: {$colors['text_link']};
} 
.sc_icons_item_description,
...
.scheme_self .sc_services_light .sc_services_item .sc_services_item_info {
	color: {$colors['text_dark']};
	background-color: {$colors['bg_color']};
}
.sc_services_numbered-image .sc_services_item .sc_services_item_info,
.scheme_self .sc_services_numbered .sc_services_item {
	color: {$colors['text_dark']};
	background-color: {$colors['bg_color']};
}
...
.sc_services.sc_services_light .sc_services_item .post_featured .sc_services_item_price,
...
.footer_wrap .scheme_self .socials_wrap .social_item .social_icon,
...
.footer_wrap .scheme_self .socials_wrap .social_item:hover .social_icon,
...
.scheme_self .sc_testimonials.sc_testimonials_simple .sc_testimonials_item {
	background-color: {$colors['bg_color']};
}
...
.team_member_page .team_member_description .team_member_position {
	color: {$colors['inverse_light']};
}
...
.team_member_page .team_member_header .team_member_details .team_member_details_label:before {
	color: {$colors['text_link']};
}
.team_member_page .team_member_header .team_member_details .team_member_details_value a {
	color: {$colors['text']};
}
.team_member_page .team_member_header .team_member_details .team_member_details_value a:hover {
	color: {$colors['text_link']};
}
...
body table.booked-calendar td.today:hover .date span {
	background: {$colors['inverse_bd_color']} !important;
...
.booked-calendar thead .page-left i:hover:before,
.booked-calendar thead .page-right i:hover:before {
	color: {$colors['text_link']} !important;
}
body table.booked-calendar td .date:hover {
	background-color: {$colors['extra_bg_color']} !important;
}
body table.booked-calendar td .date:hover .number {
