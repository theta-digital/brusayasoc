...
if ( ! function_exists( 'justitia_skin_importer_set_options' ) ) {
    ...
    function justitia_skin_importer_set_options($options = array()) {
        if (is_array($options)) {
            ...
            $options['files']['agency']['title'] = esc_html__('Agency Demo', 'justitia');
            $options['files']['agency']['domain_demo'] = esc_url( justitia_get_protocol() . '://agency.justitia.themerex.net' );   // Demo-site domain
